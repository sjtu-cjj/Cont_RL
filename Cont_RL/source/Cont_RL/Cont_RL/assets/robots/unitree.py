...
UNITREE_GO2_CFG = ArticulationCfg(
    ...
    actuators={
        ...
        "FL_thigh": DCMotorCfg(
            joint_names_expr=["FL_thigh_joint"],
            effort_limit=23.5,
            saturation_effort=23.5,
            velocity_limit=30.0,
            stiffness=25.0,
        ...
        "FL_calf": DCMotorCfg(
            joint_names_expr=["FL_calf_joint"],
            effort_limit=23.5,
            saturation_effort=23.5,
            velocity_limit=30.0,
            stiffness=25.0,
        ...
        "FR_thigh": DCMotorCfg(
            joint_names_expr=["FR_thigh_joint"],
            effort_limit=23.5,
            saturation_effort=23.5,
            velocity_limit=30.0,
            stiffness=25.0,
        ...
        "FR_calf": DCMotorCfg(
            joint_names_expr=["FR_calf_joint"],
            effort_limit=23.5,
            saturation_effort=23.5,
            velocity_limit=30.0,
            stiffness=25.0,
        ...
        "RL_thigh": DCMotorCfg(
            joint_names_expr=["RL_thigh_joint"],
            effort_limit=23.5,
            saturation_effort=23.5,
            velocity_limit=30.0,
            stiffness=25.0,
        ...
        "RL_calf": DCMotorCfg(
            joint_names_expr=["RL_calf_joint"],
            effort_limit=23.5,
            saturation_effort=23.5,
            velocity_limit=30.0,
            stiffness=25.0,
        ...
        "RR_thigh": DCMotorCfg(
            joint_names_expr=["RR_thigh_joint"],
            effort_limit=23.5,
            saturation_effort=23.5,
            velocity_limit=30.0,
            stiffness=25.0,
        ...
        "RR_calf": DCMotorCfg(
            joint_names_expr=["RR_calf_joint"],
            effort_limit=23.5,
            saturation_effort=23.5,
            velocity_limit=30.0,
            stiffness=25.0,
