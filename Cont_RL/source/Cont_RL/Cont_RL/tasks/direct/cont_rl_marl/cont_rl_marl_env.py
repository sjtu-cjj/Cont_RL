...
from .cont_rl_marl_env_cfg import ContRlMarlEnvCfg


class ContRlMarlEnv(DirectMARLEnv):
    cfg: ContRlMarlEnvCfg

    def __init__(self, cfg: ContRlMarlEnvCfg, render_mode: str | None = None, **kwargs):
